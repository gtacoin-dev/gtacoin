...
#ifndef GTACOIN_WALLET_WALLET_H
#define GTACOIN_WALLET_WALLET_H
...
// GTACOIN set to 1 as when services are stored in db they should be usable
...
public:
	...
	// GTACOIN add data and input tx for gtacoin service calls
