...
{
    BOOST_CHECK(TestSplitHost("www.gtacoin.org", "www.gtacoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.gtacoin.org]", "www.gtacoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.gtacoin.org:80", "www.gtacoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.gtacoin.org]:80", "www.gtacoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:62930", "127.0.0.1", 62930));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:62930", "127.0.0.1", 62930));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:62930", "::ffff:127.0.0.1", 62930));
    BOOST_CHECK(TestSplitHost("[::]:62930", "::", 62930));
    BOOST_CHECK(TestSplitHost("::62930", "::62930", -1));
    BOOST_CHECK(TestSplitHost(":62930", "", 62930));
    BOOST_CHECK(TestSplitHost("[]:62930", "", 62930));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:62930", "127.0.0.1:62930"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:62930", "[::]:62930"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
