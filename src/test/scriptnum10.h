...
#ifndef GTACOIN_TEST_SCRIPTNUM10_H
#define GTACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Gtacoin Core 0.10.0, for cross-comparison.
 */
public:
