...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", GtacoinUnits::GTA);
    ...
    if (!settings.contains("zecEndPoint"))
		settings.setValue("zecEndPoint", "http://zec.gtacoin.org:8080/");
    if (!settings.contains("btcEndPoint"))
        settings.setValue("btcEndPoint", "http://btc.gtacoin.org:8080/");
...
void OptionsModel::checkAndMigrate()
{
    ...
    if (settingsVersion < CLIENT_VERSION)
    {
        ...
        // see https://github.com/gtacoin/gtacoin2/pull/8273
