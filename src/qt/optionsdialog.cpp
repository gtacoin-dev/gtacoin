    ...
    mapper(0)
{
	...
	ui->zecEndPoint->setPlaceholderText("http://zec.gtacoin.org:8080/");
	ui->btcEndPoint->setPlaceholderText("http://btc.gtacoin.org:8080/");
    ...
    ui->gtacoinAtStartup->setToolTip(ui->gtacoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->gtacoinAtStartup->setText(ui->gtacoinAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new GtacoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->gtacoinAtStartup, OptionsModel::StartAtStartup);
