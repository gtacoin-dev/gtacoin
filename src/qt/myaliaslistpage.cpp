	...
	platformStyle(platformStyle)
{
    ...
    ui->labelExplanation->setText(tr("These are your registered Gtacoin Aliases. Alias operations (create, update, transfer) take 2-5 minutes to become active."));
