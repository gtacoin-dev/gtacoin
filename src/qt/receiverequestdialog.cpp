...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatGtacoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + GtacoinUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatGtacoinURI(info));
}
