...
void WalletView::setGtacoinGUI(GtacoinGUI *gui)
{
    if (gui)
    {
		...
		// GTACOIN
		aliasView->setGtacoinGUI(gui);
		messageView->setGtacoinGUI(gui);
		escrowView->setGtacoinGUI(gui);
		certView->setGtacoinGUI(gui);
		offerView->setGtacoinGUI(gui);
    }
}
