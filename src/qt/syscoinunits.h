...
#ifndef GTACOIN_QT_GTACOINUNITS_H
#define GTACOIN_QT_GTACOINUNITS_H
...
/** Gtacoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GtacoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GtacoinUnits(QObject *parent);

    /** Gtacoin units.
      @note Source: https://en.gtacoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        GTA,
...
typedef GtacoinUnits::Unit GtacoinUnit;

#endif // GTACOIN_QT_GTACOINUNITS_H
