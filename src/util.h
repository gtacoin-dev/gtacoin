 ...
 */
#ifndef GTACOIN_UTIL_H
#define GTACOIN_UTIL_H
...
extern const char * const GTACOIN_CONF_FILENAME;
extern const char * const GTACOIN_PID_FILENAME;
...
{
    std::string s = strprintf("gtacoin-%s", name);
