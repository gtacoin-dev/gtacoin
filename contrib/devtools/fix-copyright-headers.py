...
// Copyright (c) 2009-2012 The Gtacoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Gtacoin/$1-%s The Gtacoin/' %s"
REGEX_CURRENT= re.compile("%s The Gtacoin" % year)
