Gtacoin Core version 0.13.2 is now available from:

  <https://gtacoin.org/bin/gtacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update gtacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow gtacoin-tx to create v2 transactions (sysdrak)
