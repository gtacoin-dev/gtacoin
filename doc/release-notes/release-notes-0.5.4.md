Gtacoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/gtacoin/files/Gtacoin/gtacoin-0.5.4/
...
http://gitorious.org/gtacoin/gtacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Gtacoin-Qt notifications under Growl 1.3.
Increase required age of Gtacoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGtacoin properly when installing Gtacoin-Qt over it. (Windows)
