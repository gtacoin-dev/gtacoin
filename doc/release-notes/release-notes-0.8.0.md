Gtacoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/gtacoin/files/Gtacoin/gtacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Gtacoin
...
New/changed settings (command-line or gtacoin.conf file)
--------------------------------------------------------
