Download URL: https://sourceforge.net/projects/gtacoin/files/Gtacoin/gtacoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 GTA fee schedule (users still pay 0.01 GTA per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #gtacoin00 - #gtacoin99
