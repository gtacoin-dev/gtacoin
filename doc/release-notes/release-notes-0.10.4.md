Gtacoin Core version 0.10.4 is now available from:

  <https://gtacoin.org/bin/gtacoin-core-0.10.4/>
...
- #6953 `43c2789` Split gtacoin-tx into its own package
- #6953 `dfe0d4d` Include gtacoin-tx binary on Debian/Ubuntu
