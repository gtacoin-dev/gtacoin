Gtacoin Core version 0.9.2.1 is now available from:

  https://gtacoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 GTA to 0.01 GTA
...
- Fix "Start gtacoin on system login"
