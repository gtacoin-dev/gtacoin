...
This document provides guidelines for internationalization of the Gtacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gtacoin_en.ts` remains unchanged.
