...
unlocked to sign the Gtacoin-Qt.app bundle.
...
allowing somebody to distribute a Gtacoin-Qt.app or gtacoin-qt-setup.exe with a valid
...
that the gtacoin-qt.exe file inside the installer had not been tampered with.
