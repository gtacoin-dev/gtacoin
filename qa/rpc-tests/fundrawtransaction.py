...
class RawTransactionsTest(GtacoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid gtacoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid gtacoin address" in e.error['message'])
